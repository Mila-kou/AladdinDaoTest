...
title: 2026-09-06-执行器走查-XT-MKT-OPEN-001-r2 手工执行批次
date: 2026-09-06
release: v0.3.2
status: round-1-in-progress
---

# 2026-09-06-执行器走查-XT-MKT-OPEN-001-r2 手工执行批次
...
- 证据（截图 / 日志 / tx 记录）存本目录，results.md 证据列写 `TestCase/E2E/manual-runs/2026-09-06-执行器走查-XT-MKT-OPEN-001-r2/…` 相对路径。
