...
| XT-MKT-OPEN-001 | tx-fork-v0.3.2-260902-2305 · 13880f2 | RPC + 页面 | PASS | GAP | — | 链上核对（verify-tx）PASS：report PASS_WITH_GAPS；核对行 PASS 35 | TestCase/E2E/manual-runs/2026-09-06-执行器走查-XT-MKT-OPEN-001-r2/XT-MKT-OPEN-001/verify-20260906-083050.json | Claude（走查） | 2026-09-06 |
